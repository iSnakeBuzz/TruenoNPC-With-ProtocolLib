...
public class TruenoNPC_v1_8_r3 implements TruenoNPC {
    private static List<TruenoNPC_v1_8_r3> npcs;
    private static int id;
    private static boolean taskstarted;
    private static Plugin plugin;

    static {
        TruenoNPC_v1_8_r3.npcs = new ArrayList<TruenoNPC_v1_8_r3>();
        TruenoNPC_v1_8_r3.id = 0;
        TruenoNPC_v1_8_r3.taskstarted = false;
    }
    ...
    public TruenoNPC_v1_8_r3(final Location location, final TruenoNPCSkin skin) {
        this.deleted = false;
        this.rendered = new ArrayList<Player>();
        this.entityID = (int) Math.ceil(Math.random() * 1000.0) + 2000;
        this.npcid = TruenoNPC_v1_8_r3.id++;
        this.skin = skin;
        this.location = location;
        if (!TruenoNPC_v1_8_r3.npcs.contains(this)) {
            TruenoNPC_v1_8_r3.npcs.add(this);
        }
    }
    ...
    @Override
    public void delete() {
        TruenoNPC_v1_8_r3.npcs.remove(this);
    ...
    private void spawn(final Player p) {
        this.skin.getSkinDataAsync(new SkinDataReply() {
            ...
            public void done(final SkinData skinData) {
                final GameProfile profile = TruenoNPC_v1_8_r3.this.getGameProfile(randomString(4), skinData);
                if (skinData == null) {
                    TruenoNPC_v1_8_r3.this.setGameProfile(profile);
                    TruenoNPC_v1_8_r3.this.cacheSkin(skinData);
                }
                try {
                    TruenoNPC_v1_8_r3.this.spawnEntityV2(p, profile, skinData);
    ...
    private void spawnEntityV2(final Player p, final GameProfile gameprofile, final SkinData skindata) throws InvocationTargetException {
        ...
        Bukkit.getScheduler().runTaskLater(TruenoNPC_v1_8_r3.plugin, (Runnable) new Runnable() {
            @Override
            public void run() {
                TruenoNPC_v1_8_r3.this.rmvFromTablistV2(p);
            }
        }, 25L);
        this.rendered.add(p);
